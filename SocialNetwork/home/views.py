...
class PostDetailView(View):
      ...
      def get(self,request, *args, **kwargs):
            ...
            if request.user.is_authenticated and self.post_instance.user_can_like(request.user):
                  can_like=True
            return render(request, 'home/details.html',{'post':self.post_instance, 'comments':comments,'form':self.form_class,'reply_form':self.form_class_reply,'can_like':can_like})
...
class PostDeleteView(LoginRequiredMixin,View):
      def get(self,request,post_id):
            ...
            if post.user.id == request.user.id:
                  post.delete()
                  messages.success(request,'Post successfully deleted!',extra_tags='success')
            else:
...
class PostUpdateView(LoginRequiredMixin,View):
      ...
      def post(self,request, *args, **kwargs):
            ...
            if form.is_valid():
                  ...
                  new_post.save()
                  messages.success(request,'you update this post successfully:)',extra_tags='success')
...
class PostCreateView(LoginRequiredMixin, View):
      ...
      def post(self,request,*args,**kwargs):
            ...
            if form.is_valid():
                  ...
                  new_post.save()
                  messages.success(request,'You create new post!',extra_tags='success')
...
class PostLikeView(LoginRequiredMixin,View):
      def get(self,request,post_id):
            ...
            if like.exists():
                  ...
                  messages.success(request,'you like this post:)',extra_tags='success')
            return redirect('home:post_detail',post.id,post.slug)
