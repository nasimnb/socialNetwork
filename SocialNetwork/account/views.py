...
class UserRegisterView(View):
      ...
      def post(self,request):
            ...
            if form.is_valid():
                  ...
                  messages.success(request, "User successfully registered.", extra_tags='success')
                  return redirect('home:home')
            return render(request, self.template_name, {'form': form})
...
class UserLoginView(View):
      ...
      def post(self,request):
            ...
            if form.is_valid():
                  ...
                  if user is not None:
                        login(request,user)
                        messages.success(request, "User successfully login.", extra_tags='success')
                        if self.next:
...
class UserUnfollowView(LoginRequiredMixin,View):
      def get(self,request,user_id):
            ...
            if relation.exists():
                  ...
                  messages.error(request,'you are not followed this user!',extra_tags='danger')
            return redirect('account:user_profile',user.id)
